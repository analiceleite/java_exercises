    ...
    do {
      ...
      switch (opcao) {
        case 1:
          ...
          a.matricula =
            Integer.parseInt(
              EntradaSaida.solicitarDadoAluno("número da matrícula ")
            );
          ...
          for (i = 0; i < quantnotas; i++) {
            Notas n = new Notas();
            n.descricao =
              EntradaSaida.solicitarNotas("matéria correspondente ");
        ...
        case 2:
          if (!e.listadeAlunos.isEmpty()) {
            ...
            EntradaSaida.mostrarAlerta(
              "Nenhum aluno foi matriculado até o momento!"
            );
          }
          break;
        case 3:
          ...
          matricula =
            Integer.parseInt(
              EntradaSaida.solicitarDadoAluno("número da matrícula do")
            );
